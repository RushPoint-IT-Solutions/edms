...
class CopyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $copy_request_approver = new CopyApprover;
        $copy_request_approver->user_id = $document->user_id;
        $copy_request_approver->copy_request_id = $copy_request->id;
        $copy_request_approver->status = "Pending";
        $copy_request_approver->start_date = date('Y-m-d');
        $copy_request_approver->save();
    ...
    public function action(Request $request,$id)
    {
        ...
        // $copyApprover = CopyApprover::where('copy_request_id',$copyRequestApprover->copy_request_id)->where('status','Pending')->orderBy('level','asc')->first();
