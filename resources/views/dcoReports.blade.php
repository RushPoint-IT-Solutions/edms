...
<style>
    ...
    .filter-section .chosen-container-active .chosen-single {
        border-color: #8B0000;
        box-shadow: 0 0 0 0.2rem rgba(139, 0, 0, 0.15);
    }
...
<div class="row mb-4 dashboard-header">
    <div class="col-12">
        <h4 class="mb-0">Change DCO Request Reports</h4>
        <p class="text-muted mb-0">View and filter DCO change request history</p>
    </div>
</div>
    ...
    <form method='GET' onsubmit='show();' enctype="multipart/form-data">
        <div class='row align-items-end'>
            <div class="col-lg-4 col-md-6">
                <label class="form-label">Select BPO</label>
                <select name='dco' class='form-control-sm form-control cat' required>
                    <option value="">Choose BPO...</option>
            ...
            <tbody>
                @foreach($requests as $request)
                    ...
                    <tr>
                        ...
                        <td><strong>{{$difference/(24*60*60)}}</strong> day/s</td>
                        <td>
                            @if($request->status == "Pending")
    ...
    $(document).ready(function(){
        ...
        $('.tables').DataTable({
            ...
            buttons: [
                {extend: 'copy'},
                {extend: 'csv'},
                {extend: 'excel', title: 'Change DCO Request Reports'},
                {extend: 'pdf', title: 'Change DCO Request Reports'},
                {extend: 'print',
