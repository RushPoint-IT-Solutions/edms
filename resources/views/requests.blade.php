...
<style>
    ...
    .dashboard-card.cancelled .icon-circle {
        background: #d1e7dd;
        color: #0f5132;
    }
...
<div class="row mb-4 dashboard-header">
    <div class="col-12">
        <h4 class="mb-0">Copy Requests</h4>
        <p class="text-muted mb-0">Manage and track document copy requests</p>
    </div>
</div>
...
<div class="row g-3 mb-4">
    <div class="col-xl-3 col-md-6">
        <div class="dashboard-card pending">
            ...
            <h2>{{count($requests->where('status','Pending'))}}</h2>
            <p>Pending</p>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="dashboard-card cancelled">
            ...
            <h2>{{count($requests->where('status','Cancelled'))}}</h2>
            <p>Cancelled</p>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="dashboard-card declined">
            ...
            <h2>{{count($requests->where('status','Declined'))}}</h2>
            <p>Declined</p>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="dashboard-card approved">
            ...
            <h2>{{count($requests->where('status','Approved'))}}</h2>
            <p>Approved</p>
        </div>
    </div>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <span class='badge-status cancelled'>{{$request->status}}</span>
                        @endif
                    </td>
                </tr>
    ...
    $(document).ready(function(){
        ...
        $('.tables').DataTable({
            ...
            buttons: [
                {extend: 'copy'},
                {extend: 'csv'},
                {extend: 'excel', title: 'Copy Requests'},
                {extend: 'pdf', title: 'Copy Requests'},
                {extend: 'print',
