<div class="modal fade" id="editPermission{{ $permission->id }}" tabindex="-1" aria-labelledby="newModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="name" class="form-control @if($errors->has('name')) is-invalid @endif" value="{{ $permission->name }}">
                            @if($errors->has('name'))
