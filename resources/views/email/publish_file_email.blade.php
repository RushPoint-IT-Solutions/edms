                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr
                                            ...
                                            <td class="content-block"
                                                ...
                                                <div style="margin-bottom: 15px; text-align:center;">
                                                    <img src="{{ url('images/icon.png') }}" alt="" height="90">
                                                </div>
                                            </td>
                                        </tr>
                                        {{-- <tr
                                        ...
                                        <tr
                                            ...
                                            <td class="content-block"
                                                ...
                                                <br>
                                                <br>
                                                We would like to inform you that the documents <b>{{ $change_request->title }}</b> have been successfully published and are now available for your access and review.
                                                <br>
                                                <br>
                                                You may view or download the published documents through this <a href="{{ url('monitoring') }}" style="color: #a84322">link</a>. If you encounter any issues accessing the files or require further assistance, please do not hesitate to reach out.
                                                <br>
                                                <br>
