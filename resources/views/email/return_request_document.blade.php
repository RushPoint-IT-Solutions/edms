                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr
                                            ...
                                            <td class="content-block"
                                                ...
                                                <br>
                                                <br>
                                                Please be informed that the document you requested has been retrieved and is hereby returned for your review.
                                                <br>
                                                <br>
                                                To check the remarks or reason, please click the link below:
                                                <br>
                                                <br>
                                                <a href="{{ url('/change-request/view-change-request/'.$change_request->id) }}" itemprop="url"
