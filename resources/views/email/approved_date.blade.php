                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr
                                            ...
                                            <td class="content-block"
                                                ...
                                                <br>
                                                <br>
                                                Please be advised that the approval date for the following record has been antedated in the system:
                                                <br>
                                                <br>
                                                Document / Transaction: <b>{{ $document->title }}</b>
                                                <br>
                                                <br>
                                                Approved By: <b>{{ $approver->user->name }}</b>
                                                <br>
                                                <br>
                                                New Approval Date: <b>{{ date('M d Y', strtotime($approver->date_approved)) }}</b>
                                                <br>
                                                <br>
                                                This update is for documentation purposes. Kindly review and advise if further action is needed.
                                                <br>
                                                <br>
                                                Thank you.
                                                <br>
